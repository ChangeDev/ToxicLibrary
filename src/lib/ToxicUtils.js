...
class ToxicUtils {
    ...
    static async getHelpText(guild) {
        ...
        **INFORMATION**
        __GitHub Repository__: [PoeticShoko/Ryuk-Bot](https://github.com/PoeticShoko/Ryuk-Bot/)
        __Version running__: [${info.version}](https://github.com/PoeticShoko/Ryuk-Bot/commit/${info.version})`;
    }
}

module.exports = ToxicUtils;
